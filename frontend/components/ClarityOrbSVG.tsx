...
export default function ClarityOrbSVG(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 800 800"
      role="img"
    ...
    >
      <defs>
        ...
        {/* Bottom lobe gradient (blue→violet→rose) */}
      ...
      <g id="Inner" clipPath="url(#InnerClip)">
        ...
        <g id="LobeTop">
          <path
            d="M 140 390 C 235 300, 335 265, 405 292 C 480 322, 540 365, 655 360 L 655 140 L 140 140 Z"
            fill="url(#TopLobe)"
            opacity="0.95"
          />
        </g>

        {/* LobeBottom (violet→rose) */}
        <g id="LobeBottom">
          <path
            d="M 140 450 C 280 456, 360 428, 420 386 C 505 332, 575 332, 655 352 L 655 700 L 140 700 Z"
            fill="url(#BottomLobe)"
            opacity="0.95"
          />
        </g>

        {/* S-curve inner highlight */}
        <g id="SCurveHighlight">
          <path
            d="M 140 438 C 280 444, 360 416, 420 376 C 510 318, 575 323, 655 343"
